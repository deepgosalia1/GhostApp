    ...
    public void challenge(View view) {
        ...
        if(word.length()>=4 && fastDictionary.isWord(word))
            ...
            if(fastDictionary.getAnyWordStartingWith(word)!="") {
                ...
                Toast.makeText(this, "The word that can be formed: "+temp.toUpperCase(), Toast.LENGTH_SHORT).show();
            }
            else {
                Status.setText("User wins");
                Toast.makeText(this,"Computer bluffed",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void computerTurn() {
        ...
        else
        {
            if(fastDictionary.getAnyWordStartingWith(input)==null)
            {
                ...
                Toast.makeText(this,"No word can be formed using this prefix",Toast.LENGTH_SHORT).show();
            }
            else
            {
